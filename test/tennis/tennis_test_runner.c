...
TEST_GROUP_RUNNER(tennis)
{
   ...
   RUN_TEST_CASE(tennis, MATCH_POINT_during_advantage_40_40_and_player_gets_point);
   RUN_TEST_CASE(tennis, MATCH_POINT_during_advantage_in_tie_break_6_6_and_player_gets_point);
}